...
{
    [ComVisible(false)]
    public class EscalationOutcomeStep : DbBaseClass
    {
        public EscalationOutcomeStep() : this(string.Empty) { }
        public EscalationOutcomeStep(string instance)
            : base(instance)
        {
            _name = "DBCLASSLIBRARY.UpdateEscalationOutcomeStep";
            ...
            ///////////////////////////////////////////////////
            AddParm(ParameterDirection.Input,
                _parameterNames[2], "", DbType.Int32);
            ///////////////////////////////////////////////////
            // p_Name
            ///////////////////////////////////////////////////
            AddParm(ParameterDirection.Input,
            ...
            ///////////////////////////////////////////////////
            AddParm(ParameterDirection.Input,
                _parameterNames[7], "", DbType.AnsiString);
            ///////////////////////////////////////////////////
            // p_result
            ///////////////////////////////////////////////////
            AddParm(ParameterDirection.Output,
                _parameterNames[8], "", DbType.Int32);
        }
        ...
        public string Result
        {
            get
            {
                return GetValue(_parameterNames[8]);
            }
            set
            {
                SetValue(_parameterNames[8], value);
            }
        }
    }
}
