...
**************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/DbClassLibrary/CrawfordUserRecord.cs 4     7/13/10 11:39a Gwynnj $ */
#endregion
using System;
using System.Data;
...
namespace DbClassLibrary
{
	...
	public sealed class CrawfordUserRecord : ActiveRecord
	{
		private const string _table = "USERS";
		#region Constructor
		/// <summary>
		/// Initializes a new instance of the <see cref="CrawfordUserRecord"/> class.
		/// </summary>
		public CrawfordUserRecord()
			: base(_table)
		{
		...
		public CrawfordUserRecord(IDataReader reader)
			: base(reader, _table)
		{
		}
		#endregion
		...
		public string FileTransLogId
		{
			get
			{
				return GetColumnValue("FILE_TRANSMISSION_LOG_ID");
			}
			set
			{
				SetColumnValue("FILE_TRANSMISSION_LOG_ID", value);
			}
		}
		#endregion
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/DbClassLibrary/CrawfordUserRecord.cs $
 * 
