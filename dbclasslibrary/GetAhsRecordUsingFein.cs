 ...
 **************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/DbClassLibrary/GetAhsRecordUsingFein.cs 2     5/26/09 11:05a John.gwynn $ */
#endregion
...
namespace DbClassLibrary
{
	...
	public class GetAhsRecordUsingFein : DbBaseClass
	{
		/// <summary>
		...
		/// </summary>
		public GetAhsRecordUsingFein():this(String.Empty)
		{
		}
		/// <summary>
		/// Initializes a new instance of the <see cref="AhsRecord"/> class.
		...
		public GetAhsRecordUsingFein(string instance) :base (instance)
		{
			_name = "DBCLASSLIBRARY.GetLocationAhsidFromFein";
			_hasCursor = true;
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/DbClassLibrary/GetAhsRecordUsingFein.cs $
 * 
