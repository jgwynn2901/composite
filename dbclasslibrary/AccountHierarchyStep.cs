 ...
 **************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/DbClassLibrary/AccountHierarchyStep.cs 6     9/22/09 11:05a John.gwynn $ */
#endregion
...
namespace DbClassLibrary
{
	...
	public sealed class AccountHierarchyStep :DbBaseClass
	{
		#region Constructor
		/// <summary>
		/// default constructor uses the registry db instance
		/// </summary>
		public AccountHierarchyStep():this(String.Empty)
		{
		}
		/// <summary>
		...
		public AccountHierarchyStep(string instance) :base (instance)
		{
			_name = "UIFSegment.ProcessAHSSegment";
			Initialize();
		}
		#endregion
		#region Initialize
...
#region Log
/*
 * $Log: /SourceCode/Components/FNS2005/DbClassLibrary/AccountHierarchyStep.cs $
 * 
 * 6     9/22/09 11:05a John.gwynn
 * Import Field updates
 * 
 * 5     8/12/08 1:39p Jenny.cheung
 * rolled back
 * 
