...
**************************************************************************/
/* $Header: /SourceCode/Components/FNS2005/FnsUtility/CallingMethod.cs 2     1/09/08 4:18p John.gwynn $ */
#endregion
using System;
...
namespace FnsUtility
{
	...
	public class CallingMethod
	{
		...
		private void Initialize()
		{
			...
			else methodString = string.Empty;
			#endregion METHOD
			...
			if (stackFrame != null) m_LineNumber = stackFrame.GetFileLineNumber();

			string fileLine = null;
			if (stackFrame != null) m_FilePath = stackFrame.GetFileName();
...
#region History
/*
 * $History: CallingMethod.cs $
 * 
 * *****************  Version 2  *****************
 * User: John.gwynn   Date: 1/09/08    Time: 4:18p
 * Updated in $/SourceCode/Components/FNS2005/FnsUtility
 * added header/history tags
 */
#endregion